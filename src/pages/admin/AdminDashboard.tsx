...
import { Users, UserCheck, Heart, Calendar, TrendingUp, Clock } from 'lucide-react';
import { customers, caregivers, services, appointments } from '../../data/mock_data';
...
const AdminDashboard: React.FC = () => {
  const stats = {
    ...
    totalRevenue: appointments.reduce((sum, apt) => sum + apt.total_cost, 0)
  };
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {quickActions.map((action) => {
              ...
              return (
                ...
                >
                  <div className={`inline-flex p-3 rounded-lg ${action.color} mb-4 group-hover:scale-110 transition-transform duration-200`}>
